...
public class SubscribeConverter {
  ...
  public SubscribeConverter(MemberConverter memberConverter, AuthorConverter authorConverter) {
  ...
  public SubscribeEntity toEntity(Subscribe subscribe) {
    return new SubscribeEntity(
        memberConverter.toEntity(subscribe.member()), authorConverter.toEntity(subscribe.author()));
  }
