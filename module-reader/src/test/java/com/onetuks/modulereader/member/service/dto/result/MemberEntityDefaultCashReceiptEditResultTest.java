...
class MemberEntityDefaultCashReceiptEditResultTest extends ReaderIntegrationTest {
  ...
  void fromTest() {
    // Given
    MemberEntity save = memberJpaRepository.save(MemberFixture.create(RoleType.USER));
